...
function kirimTanya($data){
    ...
    if($topik == 'Proyek'){
        $proyek = htmlspecialchars($data["bidang-proyek"]);
        
        $query = "INSERT INTO pertanyaan (nama, email, topik, proyek, pertanyaan) VALUES ('$nama', '$email', '$topik', '$proyek', '$pertanyaan')";
    } else{
        $query = "INSERT INTO pertanyaan (nama, email, topik, pertanyaan) VALUES ('$nama', '$email', '$topik', '$pertanyaan')";
    }
