...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="menu_nav">
                <ul>
                    <li><a href="?p=beranda"><span>Beranda</span></a></li>
                    ...
                    <li><a href="?p=kontak"><span>Hubungi Kami</span></a></li>
                    <li class="active"><a href="admin/login.php" target="_blank"><span>Log In</span></a></li>
                </ul>
            </div>
        </div>
        <div class="main">
